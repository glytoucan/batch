...
/**
 * <p>{@link VirtSesameConnectionFactory} handles connections to a single corresponding {@link org.openrdf.repository.Repository} and manages
 * the transaction state (represented by {@link SesameTransactionObject}).</p>
 *
 * @author ameingast@gmail.com
 */
public interface VirtSesameConnectionFactory extends DisposableBean {
    /**
     ...
     * VirtSesameTransactionManager} which handles the current transaction.</p>
     *
     * @throws SesameTransactionException if
     *                                    <ul>
     *                                    <li>No transaction is active</li>
     ...
     */
    VirtSesameTransactionObject createTransaction() throws RepositoryException;
     ...
     */
    VirtSesameTransactionObject getLocalTransactionObject();
}
