...
/**
 * <p>{@link VirtSesameTransactionManager} manages the transaction lifecycle of a {@link SesameTransactionObject}.</p>
 * <p/>
...
public class VirtSesameTransactionManager extends AbstractPlatformTransactionManager {
    ...
    /**
     * <p>Creates a new {@link VirtSesameTransactionManager} for the provided {@link SesameConnectionFactory} which
     ...
     */
    public VirtSesameTransactionManager(VirtSesameConnectionFactory sesameConnectionFactory) {
    ...
    protected Object doGetTransaction() throws TransactionException {
        VirtSesameTransactionObject localTransactionObject = sesameConnectionFactory.getLocalTransactionObject();
    ...
    protected boolean isExistingTransaction(Object transaction) throws TransactionException {
    	VirtSesameTransactionObject sesameTransactionObject = (VirtSesameTransactionObject) transaction;
    ...
    private void setIsolationLevel(VirtSesameTransactionObject sesameTransactionObject, TransactionDefinition transactionDefinition) {
...
//            repositoryConnection.setIsolationLevel(isolationLevel);
    ...
    protected void doCommit(DefaultTransactionStatus status) throws TransactionException {
    	VirtSesameTransactionObject sesameTransactionObject = (VirtSesameTransactionObject) status.getTransaction();
