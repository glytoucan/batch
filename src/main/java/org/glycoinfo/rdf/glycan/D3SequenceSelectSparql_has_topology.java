...
@Component
public class D3SequenceSelectSparql_has_topology extends SelectSparqlBean {
	...
	public D3SequenceSelectSparql_has_topology(String sparql) {
		super(sparql);
	}

	public D3SequenceSelectSparql_has_topology() {
		super();
