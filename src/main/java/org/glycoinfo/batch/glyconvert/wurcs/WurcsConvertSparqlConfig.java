...
////@ComponentScan(basePackages = ("org.glycoinfo.batch.glyconvert"))
//@SpringApplicationConfiguration(classes = WurcsConvertSparqlBatch.class)
//public class WurcsConvertSparqlConfig {
//
//	// graph base to set the graph to insert into.  Will be formated to http://glytoucan.org/rdf/demo/0.7/wurcs (+ toFormat)
//	public static String graphbase = "http://glytoucan.org/rdf/demo/0.7";
...
//		return new ConvertSelectSparql();
//	}
//
//	@Bean
...
//		SparqlItemReader<SparqlEntity> reader = new SparqlItemReader();
...
//		SparqlItemWriter<SparqlEntity> reader = new SparqlItemWriter();
...
//			ItemWriter<SparqlEntity> writer,
//			ItemProcessor<SparqlEntity, SparqlEntity> processor) {
//		return stepBuilderFactory.get("step1")
//				.<SparqlEntity, SparqlEntity> chunk(10)
